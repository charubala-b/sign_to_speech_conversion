    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                # Combine labels for speech output
                current_gesture = f"{hand_sign_label}"
                # if finger_gesture_label != "":
                #     current_gesture += f" and {finger_gesture_label}"

                # Speak the gesture if it's new
                if current_gesture != last_gesture:
                    speech_converter.speak(current_gesture)
